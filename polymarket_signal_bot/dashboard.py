...
def build_dashboard_state(store: Store, *, bankroll: float = DEFAULT_BANKROLL) -> dict[str, Any]:
    ...
    return {
        "meta": {
            ...
            "livePaperStatus": _runtime_value(runtime, "live_paper_status", "offline"),
            "livePaperSummary": _runtime_value(runtime, "live_paper_last_summary", ""),
            "livePaperMetrics": _runtime_value(runtime, "live_paper_metrics", ""),
            "livePaperPolicy": _runtime_value(runtime, "live_paper_policy_active", ""),
